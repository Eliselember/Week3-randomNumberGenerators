...
namespace RandomNumberGenerators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //programm kontrollib, genereeritud number on suurem kui 5
            //kui genereeritud number on suurem, kui 5, programm kuvab
            //"juhuslik number {myRandomNumber}, see on suurem kui 5"
            //kui genereeritud number on väiksem, kui 5, siis programm kuvab
            //"juhuslik number {myRandomNumber}, see on väiksem kui 5"
